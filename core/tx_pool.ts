...
const check_tx = async (tx:T.Tx,my_version:number,native:string,unit:string,chain:T.Block[],token_name_maxsize:number,StateData:Trie,LocationData:Trie)=>{
...
export async function Tx_to_Pool(pool:T.Pool,tx:T.Tx,my_version:number,native:string,unit:string,chain:T.Block[],token_name_maxsize:number,StateData:Trie,LocationData:Trie){
