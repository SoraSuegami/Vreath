...
export async function AcceptRequestTx(tx:T.RequestTx,chain:T.Block[],validator:string,key_currency:string,fee_by_size:number,StateData:Trie,RequestData:Trie){
